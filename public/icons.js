(function () {
  ...
  const ICON_PATHS = {
    ...
    settings: '<circle cx="12" cy="12" r="3.25"/><path d="M19.4 15a1 1 0 0 0 .2 1.1l.1.1a1.6 1.6 0 1 1-2.26 2.26l-.1-.1a1 1 0 0 0-1.1-.2 1 1 0 0 0-.6.92V19a1.6 1.6 0 1 1-3.2 0v-.14a1 1 0 0 0-.65-.92 1 1 0 0 0-1.09.2l-.1.1A1.6 1.6 0 1 1 8.36 16l.1-.1a1 1 0 0 0 .2-1.1 1 1 0 0 0-.92-.6H7.6a1.6 1.6 0 1 1 0-3.2h.14a1 1 0 0 0 .92-.65 1 1 0 0 0-.2-1.09l-.1-.1A1.6 1.6 0 1 1 10.62 6.9l.1.1a1 1 0 0 0 1.1.2h.04a1 1 0 0 0 .6-.92V6a1.6 1.6 0 1 1 3.2 0v.14a1 1 0 0 0 .65.92 1 1 0 0 0 1.09-.2l.1-.1a1.6 1.6 0 0 1 2.26 2.26l-.1.1a1 1 0 0 0-.2 1.1v.04a1 1 0 0 0 .92.6h.14a1.6 1.6 0 1 1 0 3.2h-.14a1 1 0 0 0-.92.65Z"/>',
